          ...
          <div className="space-y-10 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <Button
                ...
                className="bg-gradient-to-r from-pink-500 to-red-500 hover:brightness-110 text-white text-base px-6 py-3 rounded-full font-semibold shadow-lg transition-all duration-200 flex items-center gap-2"
              >
              ...
              className="text-sm text-gray-400 hover:text-white underline underline-offset-4 transition duration-150">
                Already have one
              </button>
            </div>
          </div>
