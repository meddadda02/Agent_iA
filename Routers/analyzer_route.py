...
async def moderate_audio_file(
    ...
    """Transcrit un fichier audio avec Whisper (via Groq) puis analyse le texte - Authentification requise"""
    try:
        ...
        client = Groq()  # Assumes your GROQ_API_KEY is set in the environment
        ...
        raise HTTPException(status_code=500, detail="Erreur lors de l'analyse du fichier audio.")
